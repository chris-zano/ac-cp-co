"""
Shared base functionality for AWS Config custom rules.
Handles rule evaluation, configuration item processing, and compliance reporting.
"""
import datetime
import json
import boto3
...
def evaluate_compliance(configuration_item, rule_parameters):
    ...
    Rule evaluators should be named: {customFunctionPrefix}_evaluate_compliance
    """
    rule_eval = globals()[
